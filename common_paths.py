...
template_directory = os.path.abspath(os.path.join(work_directory,
                                                  'template'))
test_root_directory = os.path.abspath(os.path.join(script_directory,
                                                   '..', '..'))

spec_filename = os.path.join(work_directory, "spec.src.json")
generated_spec_json_filename = os.path.join(work_directory, "spec_json.js")

# TODO(kristijanburnik): Put as part of spec.
